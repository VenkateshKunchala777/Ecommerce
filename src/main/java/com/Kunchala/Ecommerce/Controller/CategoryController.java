...
import com.Kunchala.Ecommerce.Service.CategoryService;
...
public class CategoryController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CategoryDto> updateCategory(@PathVariable Long id, @RequestBody @Validated CategoryDto categoryDto) {
